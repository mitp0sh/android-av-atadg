...
.method constructor <init>(Ljava/util/ArrayList;II)V
    ...
    iput p3, p0, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->a:I
...
.method public synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->la()Lcom/google/android/gms/games/appcontent/AppContentSection;
...
.method public synthetic getActions()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->lb()Ljava/util/ArrayList;
...
.method public kP()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->JG:Lcom/google/android/gms/common/data/DataHolder;

    iget-object v1, p0, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->XX:Ljava/util/ArrayList;

    const-string v2, "section_data"

    iget v3, p0, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->KZ:I

    invoke-static {v0, v1, v2, v3}, Lcom/google/android/gms/games/appcontent/AppContentUtils;->d(Lcom/google/android/gms/common/data/DataHolder;Ljava/util/ArrayList;Ljava/lang/String;I)Landroid/os/Bundle;
...
.method public kY()Landroid/net/Uri;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->aR(Ljava/lang/String;)Landroid/net/Uri;
...
.method public synthetic kZ()Ljava/util/List;
    .locals 1

    invoke-virtual {p0}, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->lc()Ljava/util/ArrayList;
...
.method public lb()Ljava/util/ArrayList;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/google/android/gms/games/appcontent/AppContentUtils;->a(Lcom/google/android/gms/common/data/DataHolder;Ljava/util/ArrayList;Ljava/lang/String;I)Ljava/util/ArrayList;
...
.method public lc()Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget v0, p0, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->a:I
    ...
    :goto_0
    iget v2, p0, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->a:I

    if-ge v0, v2, :cond_0

    new-instance v2, Lcom/google/android/gms/games/appcontent/AppContentCardRef;

    iget-object v3, p0, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->XX:Ljava/util/ArrayList;

    iget v4, p0, Lcom/google/android/gms/games/appcontent/AppContentSectionRef;->KZ:I
