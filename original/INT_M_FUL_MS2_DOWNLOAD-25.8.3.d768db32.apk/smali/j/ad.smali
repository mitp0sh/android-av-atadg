...
.method public static a(Landroid/content/Context;)Lj/m;
    ...
    :cond_0
    invoke-static {p0}, Lj/ad;->b(Landroid/content/Context;)V

    invoke-static {p0}, Lj/ad;->c(Landroid/content/Context;)Lj/m;

    move-result-object v0

    sput-object v0, Lj/ad;->b:Lj/m;

    :try_start_0
    sget-object v0, Lj/ad;->b:Lj/m;

    invoke-static {p0}, Lj/ad;->d(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-static {v1}, Lh/e;->a(Ljava/lang/Object;)Lh/d;

    move-result-object v1

    const v2, 0x5d3f18

    invoke-interface {v0, v1, v2}, Lj/m;->a(Lh/d;I)V
    :try_end_0
    ...
    invoke-direct {v1, v0}, Lcom/google/android/gms/maps/model/b;-><init>(Landroid/os/RemoteException;)V
...
.method private static a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lj/ad;->a(Ljava/lang/Class;)Ljava/lang/Object;
    :try_end_0
...
.method private static c(Landroid/content/Context;)Lj/m;
    .locals 2

    invoke-static {}, Lj/ad;->a()Z

    move-result v0

    if-eqz v0, :cond_0

    const-class v0, Lj/ad;
    ...
    invoke-static {}, Lj/ad;->b()Ljava/lang/Class;
    ...
    invoke-static {v0, v1}, Lj/ad;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/os/IBinder;

    invoke-static {v0}, Lj/m$a;->a(Landroid/os/IBinder;)Lj/m;
...
.method private static d(Landroid/content/Context;)Landroid/content/Context;
    ...
    sget-object v0, Lj/ad;->a:Landroid/content/Context;
    ...
    sput-object v0, Lj/ad;->a:Landroid/content/Context;
