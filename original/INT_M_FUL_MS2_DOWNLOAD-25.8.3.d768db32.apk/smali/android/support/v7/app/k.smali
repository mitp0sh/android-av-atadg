...
.method public a()Landroid/support/v7/app/ActionBar;
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v7/app/r;-><init>(Landroid/app/Activity;Landroid/support/v7/app/a;)V

    return-object v0
.end method

.method a(Landroid/content/Context;Landroid/support/v7/view/ActionMode$Callback;)Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;
    .locals 1
...
.method public a(Landroid/support/v7/view/ActionMode$Callback;)Landroid/support/v7/view/ActionMode;
    ...
    .line 178
    :cond_0
    invoke-virtual {p0}, Landroid/support/v7/app/k;->l()Landroid/content/Context;

    move-result-object v1

    .line 180
    invoke-virtual {p0, v1, p1}, Landroid/support/v7/app/k;->a(Landroid/content/Context;Landroid/support/v7/view/ActionMode$Callback;)Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;
    ...
    .line 184
    iget-object v3, p0, Landroid/support/v7/app/k;->a:Landroid/support/v7/app/ActionBarActivity;
    ...
    .line 187
    invoke-virtual {p0, v1, v3}, Landroid/support/v7/app/k;->a(Landroid/content/Context;Landroid/view/ActionMode;)Landroid/support/v7/internal/view/ActionModeWrapper;
...
.method public a(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/k;->k()Ljava/lang/String;
    ...
    .line 57
    :cond_0
    invoke-super {p0, p1}, Landroid/support/v7/app/b;->a(Landroid/os/Bundle;)V
...
.method public a(Landroid/view/ActionMode;)V
    ...
    invoke-virtual {p0, v1, p1}, Landroid/support/v7/app/k;->a(Landroid/content/Context;Landroid/view/ActionMode;)Landroid/support/v7/internal/view/ActionModeWrapper;
