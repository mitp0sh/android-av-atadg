...
# instance fields
.field final a:Landroid/support/v7/view/ActionMode$Callback;

.field final b:Landroid/content/Context;

.field private c:Landroid/support/v7/internal/view/ActionModeWrapper;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/ActionMode$Callback;)V
    ...
    .line 119
    iput-object p1, p0, Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;->b:Landroid/content/Context;

    .line 120
    iput-object p2, p0, Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;->a:Landroid/support/v7/view/ActionMode$Callback;

    .line 121
    return-void
.end method

.method private a(Landroid/view/ActionMode;)Landroid/support/v7/view/ActionMode;
    .locals 1

    .prologue
    .line 152
    iget-object v0, p0, Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;->c:Landroid/support/v7/internal/view/ActionModeWrapper;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;->c:Landroid/support/v7/internal/view/ActionModeWrapper;

    iget-object v0, v0, Landroid/support/v7/internal/view/ActionModeWrapper;->b:Landroid/view/ActionMode;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;->b:Landroid/content/Context;
...
.method public onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    .prologue
    .line 138
    iget-object v0, p0, Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;->a:Landroid/support/v7/view/ActionMode$Callback;

    invoke-direct {p0, p1}, Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;->a(Landroid/view/ActionMode;)Landroid/support/v7/view/ActionMode;
...
.method public setLastStartedActionMode(Landroid/support/v7/internal/view/ActionModeWrapper;)V
    ...
    .prologue
    .line 148
    iput-object p1, p0, Landroid/support/v7/internal/view/ActionModeWrapper$CallbackWrapper;->c:Landroid/support/v7/internal/view/ActionModeWrapper;
