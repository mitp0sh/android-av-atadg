...
.field b:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
...
.method public constructor <init>(Landroid/support/v7/internal/view/menu/MenuBuilder;)V
    ...
    .line 44
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;
...
.method public dismiss()V
    ...
    .prologue
    .line 141
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->c:Landroid/app/AlertDialog;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .prologue
    .line 170
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->b:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
...
.method public onCloseMenu(Landroid/support/v7/internal/view/menu/MenuBuilder;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 99
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->c:Landroid/app/AlertDialog;
...
.method public show(Landroid/os/IBinder;)V
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->b:Landroid/support/v7/internal/view/menu/ListMenuPresenter;

    .line 64
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->b:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
    ...
    .line 65
    iget-object v2, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->b:Landroid/support/v7/internal/view/menu/ListMenuPresenter;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/MenuDialogHelper;->c:Landroid/app/AlertDialog;
