...
.method private a(Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;
    .locals 5
    ...
    .line 241
    invoke-virtual {v0, p0, p1, p2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;->a(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/app/ActionBar$Tab;Z)V
    ...
    .line 250
    iget-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d:Landroid/support/v7/internal/widget/al;
    ...
    invoke-direct {v1, p0, v4}, Landroid/support/v7/internal/widget/al;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/internal/widget/aj;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d:Landroid/support/v7/internal/widget/al;
...
.method static synthetic a(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;
    .locals 1

    .prologue
    .line 44
    invoke-direct {p0, p1, p2}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->a(Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;
...
.method private a()Z
    ...
    .prologue
    .line 128
    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->f:Landroid/support/v7/internal/widget/am;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->f:Landroid/support/v7/internal/widget/am;

    invoke-virtual {v0}, Landroid/support/v7/internal/widget/am;->getParent()Landroid/view/ViewParent;
...
.method private b()V
    ...
    .line 141
    invoke-direct {p0}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->d()Landroid/support/v7/internal/widget/am;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->f:Landroid/support/v7/internal/widget/am;
    ...
    invoke-direct {v1, p0, v4}, Landroid/support/v7/internal/widget/ak;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/support/v7/internal/widget/aj;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/am;->a(I)V
...
.method private d()Landroid/support/v7/internal/widget/am;
    .locals 4
    ...
    invoke-direct {v0, v1, v2, v3}, Landroid/support/v7/internal/widget/am;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/am;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 194
    invoke-virtual {v0, p0}, Landroid/support/v7/internal/widget/am;->b(Landroid/support/v7/internal/widget/AdapterViewICS$OnItemClickListener;)V
...
.method public addTab(Landroid/support/v7/app/ActionBar$Tab;IZ)V
    ...
    .line 274
    invoke-direct {p0, p1, v5}, Landroid/support/v7/internal/widget/ScrollingTabContainerView;->a(Landroid/support/v7/app/ActionBar$Tab;Z)Landroid/support/v7/internal/widget/ScrollingTabContainerView$TabView;
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/ak;->notifyDataSetChanged()V
...
.method public animateToTab(I)V
    ...
    invoke-direct {v1, p0, v0}, Landroid/support/v7/internal/widget/aj;-><init>(Landroid/support/v7/internal/widget/ScrollingTabContainerView;Landroid/view/View;)V
